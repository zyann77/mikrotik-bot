...
console.log('Bot RnBNET 4-Server (Detail Info) Berhasil Berjalan...');
...
bot.on('message', async (msg) => {
    ...
    if (dataSesi && dataSesi.status === 'WAITING_FOR_NAME') {
        ...
        // Konfigurasi IP, Port, dan Akun MikroTik
        let hostMikrotik = '';
        ...
        try {
            ...
            // Ekstrak data komplit dari MikroTik
            ...
            const comment = user['comment'] || 'Tidak ada catatan/keterangan';

            // Set Format Waktu Detail Indonesia (WIB)
            const opsiWaktu = { 
                weekday: 'long', 
                year: 'numeric', 
                month: 'long', 
            ...
            // 1. Kirim hasil info komplit ke HP Teknisi
